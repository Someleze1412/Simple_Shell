 ...
 * @info:  this struct containing potential arguments.for  constant function prototypes.
 *  Return: 0 always
 */
...
/**
 * set_alias - this code  set alias to strings
 * @info: this is the parameter structures
 * @str: String alias
 *
 ...
 * @info: the Structure containing arguments.  to maintain function prototypes.
 *  Return: Always 0
 */
